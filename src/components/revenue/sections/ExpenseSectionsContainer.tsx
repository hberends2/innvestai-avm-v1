...
import ExpenseSectionContainer from "./ExpenseSectionContainer";
import ExpenseHeader from "../ExpenseHeader";
import { CalculationHelpers } from "../RevenueTableHelpers";

interface ExpenseSectionsContainerProps {
...
const ExpenseSectionsContainer: React.FC<ExpenseSectionsContainerProps> = (props) => {
  return (
    <>
      <ExpenseHeader 
        showDropdown={false}
...
export default ExpenseSectionsContainer;
