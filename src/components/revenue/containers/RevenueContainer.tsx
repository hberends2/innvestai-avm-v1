...
import RevenueSectionsContainer from "../sections/RevenueSectionsContainer";
...
const RevenueContainer: React.FC<RevenueContainerProps> = (props) => {
  return (
    <RevenueSectionsContainer
